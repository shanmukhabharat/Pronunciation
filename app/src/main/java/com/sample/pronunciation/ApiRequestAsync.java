...
/**
 * Created by bharat on 10/5/16.
 */
public class ApiRequestAsync extends AsyncTask {

    private static final String TAG = ApiRequestAsync.class.getName();
    ...
    public ApiRequestAsync(Activity activity, String apiKey, boolean isOverlayRequired, String imageUrl, String language, IOCRCallBack iOCRCallBack) {
